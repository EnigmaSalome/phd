...
## CD4
```{r cd4, fig.width=22, fig.height=6, message=F}
...
# ggsave("~/Projects/phd/data/figures/chapter_02/figs_unfinished/section2/appendix1_markergenes/ch2_suppfigure_cd4.pdf", width=22, height=6)
```


## CD8
```{r cd8, fig.width=22, fig.height=6, message=F}
...
# ggsave("~/Projects/phd/data/figures/chapter_02/figs_unfinished/section2/appendix1_markergenes/ch2_suppfigure_cd8.pdf", width=22, height=6)
```


## iNKT
```{r nkt, fig.width=22, fig.height=6, message=F}
...
# ggsave("~/Projects/phd/data/figures/chapter_02/figs_unfinished/section2/appendix1_markergenes/ch2_suppfigure_nkt.pdf", width=22, height=6)
```


## MAIT
```{r mait, fig.width=22, fig.height=6, message=F}
...
# ggsave("~/Projects/phd/data/figures/chapter_02/figs_unfinished/section2/appendix1_markergenes/ch2_suppfigure_mait.pdf", width=22, height=6)
```


## $\gamma\delta$T
```{r gdt, fig.width=22, fig.height=6, message=F}
...
# ggsave("~/Projects/phd/data/figures/chapter_02/figs_unfinished/section2/appendix1_markergenes/ch2_suppfigure_gdt.pdf", width=22, height=6)
```
