...
lineage_clustersperdonor(seurobj = seur_thym$nkt, col_vector = cols_thym_nkt, file_name = "ch2_fig10_inkt_clustersperdonor.pdf")
```
...
# ggsave("~/Projects/phd/data/figures/chapter_02/figs_unfinished/section2/ch2_fig10_inkt_dotplot.pdf", width=4, height=8)
```
...
ggplot(
  ...
  theme_cowplot()
# ggsave("~/Projects/phd/data/figures/chapter_02/figs_unfinished/section2/ch2_fig10_inkt_type1_17_coexpression.pdf", width=6, height=4)
```
...
lineage_clustersperdonor(seurobj = seur_thym$mait, col_vector = cols_thym_mait, file_name = "ch2_fig10_mait_clustersperdonor.pdf")
```
...
## DimPlot
```{r gdt-umap}
lineage_dimplot(seurobj = seur_thym$gdt, col_vector = cols_thym_gdt, file_name = "ch2_fig10_gdt_umap.pdf")

lineage_clustersperdonor(seurobj = seur_thym$gdt, col_vector = cols_thym_gdt, file_name = "ch2_fig10_gdt_clustersperdonor.pdf", figwidth=5)
```
...
# ggsave("~/Projects/phd/data/figures/chapter_02/figs_unfinished/section2/ch2_fig10_gdt_markergenes.pdf", width=11, height=5)
```


## Gene signatures
```{r gdt-gene-signatures, fig.height=5, fig.width=10}
lineage_genesignature(seuratobj = seur_thym$gdt, genesignature = "park_gdT", file_name = "ch2_fig10_gdt_parkGD_sig.pdf")
lineage_genesignature(seuratobj = seur_thym$gdt, genesignature = "park_CD8aa1", file_name = "ch2_fig10_gdt_cd8aa_sig.pdf")
lineage_genesignature(seuratobj = seur_thym$gdt, genesignature = "park_CD8aa2", file_name = "ch2_fig10_gdt_cd8aa2_sig.pdf")
# lineage_genesignature(seuratobj = seur_thym$gdt, genesignature = "park_abT_entry", file_name = "ch2_fig10_gdt_SPentry_sig.pdf")
# lineage_genesignature(seuratobj = seur_thym$gdt, genesignature = "naive", file_name = "ch2_fig10_gdt_naive.pdf")
lineage_genesignature(seuratobj = seur_thym$gdt, genesignature = "effector", file_name = "ch2_fig10_gdt_effector.pdf")
lineage_genesignature(seuratobj = seur_thym$gdt, genesignature = "egress", file_name = "ch2_fig10_gdt_egress.pdf")
```
...
lineage_nebulosagenes(seuratobj = seur_thym$gdt, genes_vector = gdt_genes_nebulosa, pgrid_ncol = 2, pgrid_size = c(10,30), file_name = "ch2_fig10_gdt_densityplots.pdf")
```
...
lineage_dotplot(
  ...
  genes_vector = c(gdt_genes_dotplot),
  lines_coord = c(4.5, 7.5, 10.5, 12.5, 14.5, 22.5, 28.5, 31.5, 34.5, 36.5),
  p_size = c(5, 8.5),
  file_name = "ch2_fig10_gdt_dotplot.pdf"
)
```
