...
terekhovadf <- cbind(genes.terekhova_general[,"MAITcells"], genes.terekhova_cd4, genes.terekhova_cd8, genes.terekhova_gdt) %>%
  ...
  mutate(geneprogram=paste0("Terekhova | ", geneprogram),
         geneprogram_cat=case_when(
           geneprogram=="Terekhova | MAITcells"                ~ "terekhova_MAIT",
           geneprogram=="Terekhova | CD4_Tnaive"               ~ "terekhova_Tnaive_CD4",
           ...
           geneprogram=="Terekhova | CD8_Tnaive"        ~ "terekhova_Tnaive_CD8",
           ...
           geneprogram=="Terekhova | GD_naive"     ~ "terekhova_GD_naive",
           geneprogram=="Terekhova | GD_Vd2_GZMK+" ~ "terekhova_GD_Tem",
           geneprogram=="Terekhova | GD_Vd2_GZMB+" ~ "terekhova_GD_Tem",
           geneprogram=="Terekhova | GD_Vd1_GZMK+" ~ "terekhova_GD_Tem",
           geneprogram=="Terekhova | GD_Vd1_GZMB+" ~ "terekhova_GD_Tem"
         ))
...
longdf <- bind_rows(gene_signatures_df, .id="dataset") %>%
  ...
  filter(!geneprogram_cat %in% c("terekhova_Trm", "terekhova_other", "terekhova_MAIT"))
...
for(gp in unique(longdf$geneprogram_cat)){
  ...
  gene_signatures_list[[gp]] <- genes_in_program
}
...
colnames(seur_pbmc@meta.data)[32:45] <- names(gene_signatures_list)
```

```{r gene-signatures-plot, fig.height=6, fig.width=6}
for(gp in names(gene_signatures_list)[7:14]){
  print(gp)
  lineage_genesignature(seur_pbmc, gp, file_name = paste0("ch3_fig1_literature_signatures/", gp, ".pdf"))
}
lineage_genesignature(seur_pbmc, "rose_Tem")
lineage_genesignature(seur_pbmc, "rose_Tem")
```
