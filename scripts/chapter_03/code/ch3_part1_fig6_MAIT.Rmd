...
seur_mait@meta.data$clusters_per_lineage_annotated <- case_when(
  ...
  seur_mait@meta.data$clusters_per_lineage=="MAIT_pbmc_c0" ~ "MAIT (c0)",
  seur_mait@meta.data$clusters_per_lineage=="MAIT_pbmc_c1" ~ "MAIT (c1)",
  seur_mait@meta.data$clusters_per_lineage=="MAIT_pbmc_c2" ~ "MAIT (c2)",
