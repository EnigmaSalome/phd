...
Check expression of genes of interest in mouse data.
```{r, fig.height=7, fig.width=5}
do_DotPlot(
  seur_chopp_mouse,
  group.by="cluster",
  features=c(
    "Rag1", "Dntt", "Cd4", "Cd8a", "Cd8b1",
    "Ccr9",
    "Ccr7",
    "Zbtb16",
    "Il2rb", "Tbx21", "Ifng", "Gzmk", "Rorc", "Rora", "Ccr6", "Il17rb"
  ),
  flip=T,
  use_viridis = T,
  viridis.palette="B"
...
grep("Ceb", rownames(seur_chopp_mouse), value=T)
```
